...
import pankaj.unknowndeveloper.e_com.Adapter.SlidingAdapter;
...
public class Onbording extends AppCompatActivity {
   ...
   Animation animation;
    ...
    btn=(Button)findViewById(R.id.get_started_btn);
        addDots(0);
    ...
    ViewPager.OnPageChangeListener changeListener=new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            {
                animation= AnimationUtils.loadAnimation(Onbording.this,R.anim.animation);
    ...
    {
        startActivity(new Intent(Onbording.this,MainActivity.class));
